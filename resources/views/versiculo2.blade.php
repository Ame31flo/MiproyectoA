...
<x-app-layout>
    ...
    <tr>
        <td colspan="2" style="text-align: center;"> <img src="{{ asset('imagenes/felicidad.jpg') }}" alt=Felcidad" width="200" height="150"></td>
    </tr>
    <tr>
        <td>
            <ul>
        ...
        <td>
            En el principio creo Dios los cielos y la tierra <br> Genesis 1:1
        </td>
    </tr>
